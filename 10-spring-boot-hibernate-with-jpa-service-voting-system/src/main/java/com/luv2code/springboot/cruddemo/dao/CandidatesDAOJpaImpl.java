...
public class CandidatesDAOJpaImpl implements CandidatesDAO {
	...
	//save or update 
	@Override
	public void saveC(Candidates theCandidate) {
		Candidates dbEmployee=entityManager.merge(theCandidate);
		theCandidate.setCandidate_id(dbEmployee.getCandidate_id());
